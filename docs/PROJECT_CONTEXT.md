...
(итерация 21); ещё два пока используют MCQ. Три пилотных урока hard 12 / soft 18 /
Hi-Lo cancellation доступны отдельно. Старые 54 упражнения сохранены для
Quick Review и завершения старых сессий. Остальной путь ещё не реализован.
