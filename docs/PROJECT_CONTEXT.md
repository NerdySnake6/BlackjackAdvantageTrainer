...
На исходном пути из шести узлов четыре вводных урока переработаны в игровые
(итерация 21), а first-strategy — в игровые решения (итерация 22).
Hi-lo-intro пока использует MCQ. Добавлены dealer-upcard и hard-doubles;
итерация 23 добавляет hard-13-16, soft-13-17 и pairs-core с решениями после Split.
Три пилотных урока hard 12 / soft 18 / Hi-Lo cancellation сохранены отдельно.
Старые 54 упражнения остаются для Quick Review и завершения старых сессий.
Остальной путь ещё не реализован.
...
Исключение по решению владельца от 2026-09-05: итерация 10 временно отложена
из-за отсутствия участников; техническая работа продолжается с итерации 11.
Это не означает прохождение пилота или отмену остальных пользовательских
gates. Проверка понятности на реальных участниках остаётся незавершённой.

Дополнение владельца от 2026-09-08: требование пилота перед расширением Free
временно отложено, разрешён переход к итерации 21. Пилот не считается пройденным.
Критерии наблюдения, Free-beta, проверки интереса к Pro и независимого
математического review сохраняются; технические тесты не заменяют участников.
...
- отдельные проверки трёх пилотных уроков на новых задачах (9/10, два варианта,
  сохранение каждого ответа, разбор в конце); это не полные сертификаты навыка;
